...
//	ApiAIPromises: any;
	...
	constructor(public navCtrl: NavController ) {//public navCtrl: NavController, public dialogflowHandlerProvider : DialogflowHandlerProvider, public errorHandlerProvider : ErrorHandlerProvider, public platform: Platform, public ngZone: NgZone
//		platform.ready().then(() => {
//
//			ApiAIPromises.init({
